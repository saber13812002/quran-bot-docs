...
](https://github.com/shuding/nextra/issues/new?title=Feedback%20for%20%E2%80%9C%3CBleed%3E%20Component%E2%80%9D&labels=feedback)[Edit
this page on GitHub
](https://github.com/shuding/nextra/tree/main/docs/app/docs/built-
ins/bleed/page.mdx)Scroll to top

[Documentation](/docs "Documentation")[Built-In Components](/docs/built-ins
"Built-In Components")Bleed
...
_There is nothing to writing. All you do is sit down at a typewriter
and**bleed**._

— Ernest Hemingway

It provides a better reading experience when you want to present some
graphical information, which normally looks nicer in a larger size.

For example, you can put text, image, video or any component inside:

You can even make it full-bleed using `<Bleed full>`:

![Nextra](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fopengraph-
image.87a47b86.jpeg&w=3840&q=75)
...
[Search](/docs/built-ins/search "Search")[Callout](/docs/built-ins/callout
"Callout")
