...
](https://github.com/shuding/nextra/issues/new?title=Feedback%20for%20%E2%80%9CCustomize%20the%20Cascade%20Layers%E2%80%9D&labels=feedback)[Edit
this page on GitHub
](https://github.com/shuding/nextra/tree/main/docs/app/docs/advanced/customize-
the-cascade-layers/page.mdx)Scroll to top

[Documentation](/docs "Documentation")[Advanced](/docs/advanced
"Advanced")Customize Cascade Layers

# Customize the Cascade Layers

In some scenarios, you may need more control over the Nextra predefined CSS to
avoid unintended overrides of styles within cascade layers. Below is an
example of how `nextra-theme-docs` uses [postcss-import
](https://github.com/postcss/postcss-import) to place predefined CSS into a
...
[Playground](/docs/advanced/playground "Playground")[Twoslash
Support](/docs/advanced/twoslash "Twoslash Support")
