...
[Question? Give us feedback
](https://github.com/shuding/nextra/issues/new?title=Feedback%20for%20%E2%80%9C%3CNotFoundPage%3E%20Component%E2%80%9D&labels=feedback)[Edit
this page on GitHub
](https://github.com/shuding/nextra/tree/main/docs/app/docs/docs-theme/built-
ins/not-found/page.mdx)Scroll to top
...
Option| Type| Default Value| Description  
---|---|---|---  
`content`| `ReactNode`| `'Submit an issue about broken link'`| Content of the
link.  
`labels`| `string`| `'bug'`| Labels that can be added to the new created
issue.  
...
[Navbar](/docs/docs-theme/built-ins/navbar "Navbar")[API](/docs/docs-theme/api
"API")
...
[Question? Give us feedback
](https://github.com/shuding/nextra/issues/new?title=Feedback%20for%20%E2%80%9CNpm2Yarn%E2%80%9D&labels=feedback)[Edit
this page on GitHub
](https://github.com/shuding/nextra/tree/main/docs/app/docs/advanced/npm2yarn/page.mdx)Scroll
to top
...
Nextra uses [`@theguild/remark-
npm2yarn`](https://npmjs.com/package/@theguild/remark-npm2yarn) package that
replaces the code block that has `npm2yarn` metadata with [`<Tabs>` and
`<Tabs.Tab>` components](/docs/guide/built-ins/tabs) from `nextra/components`.
...
[Advanced](/docs/advanced "Advanced")[Mermaid](/docs/advanced/mermaid
"Mermaid")
...
[Question? Give us feedback
](https://github.com/shuding/nextra/issues/new?title=Feedback%20for%20%E2%80%9Cpage.mdx%20File%E2%80%9D&labels=feedback)[Edit
this page on GitHub
](https://github.com/shuding/nextra/tree/main/docs/app/docs/file-
conventions/page-file/page.mdx)Scroll to top

[Documentation](/docs "Documentation")[File Conventions](/docs/file-
conventions "File Conventions")`page.mdx`

# `page.mdx` File

[`page` file](https://nextjs.org/docs/app/api-reference/file-conventions/page)
is a special [Next.js App Router convention file
...
[File Conventions](/docs/file-conventions "File
Conventions")[`_meta.js`](/docs/file-conventions/meta-file "\[object
Object\]")
...
To prevent unstyled elements, import `useMDXComponents` from your `mdx-
components` file. Call this function and pass the returned components to the
`components` prop. You can also include your custom components as the first
argument:
...
[Remote Content](/docs/advanced/remote "Remote Content")[Customize Cascade
Layers](/docs/advanced/customize-the-cascade-layers "Customize Cascade
Layers")
...
[Question? Give us feedback
](https://github.com/shuding/nextra/issues/new?title=Feedback%20for%20%E2%80%9CPosts%20Page%E2%80%9D&labels=feedback)[Edit
this page on GitHub
](https://github.com/shuding/nextra/tree/main/docs/app/docs/blog-
theme/posts/page.mdx)Scroll to top
...
[Get Posts and Their Tags](/docs/blog-theme/get-posts-and-tags "Get Posts and
Their Tags")[`/tags/:id` Page](/docs/blog-theme/tags "\[object
Object\], Page")
