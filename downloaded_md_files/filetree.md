...
](https://github.com/shuding/nextra/issues/new?title=Feedback%20for%20%E2%80%9C%3CFileTree%3E%20Component%E2%80%9D&labels=feedback)[Edit
this page on GitHub
](https://github.com/shuding/nextra/tree/main/docs/app/docs/built-
ins/filetree/page.mdx)Scroll to top

[Documentation](/docs "Documentation")[Built-In Components](/docs/built-ins
"Built-In Components")FileTree
...
with the `name` attribute. Use `defaultOpen` to set the folder to open on
load.
...
[Cards](/docs/built-ins/cards "Cards")[Steps](/docs/built-ins/steps "Steps")
